"""
Django settings for projectAllocation project.
...
SECRET_KEY = 'ctll)vi4dt&#)1gn6b&iw*&k$im63#356c1(r--y=yv6tm-p^y'
...
ROOT_URLCONF = 'projectAllocation.urls'
...
WSGI_APPLICATION = 'projectAllocation.wsgi.application'
